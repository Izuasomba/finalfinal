...
# Naive Bayes function trained on title
...
# Logistic Regression function trained on title
...
# Random Forest function trained on title
...
# Naive Bayes function trained on body
def evaluate_naive_bayes_body(x_train_body, y_train_body, x_test_body, y_test_body):
    ...
    nb_body = GaussianNB()
    # Train the model
    nb_body.fit(x_train_body, y_train_body)  
...
# Logistic regression function trained on body
def evaluate_logistic_regression_body(x_train_body, y_train_body, x_test_body, y_test_body):
    ...
    # Train the model
    log_reg_body.fit(x_train_body, y_train_body)  
    # Make predictions
...
# Random forest function trained on body
...
# Naive Bayes function trained on body and title
...
# Logistic Regression function trained on body and title
...
# Random Forest function trained on body and title
